<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb=10">
                <a href="{{ route('food.create') }}" class="bg-green-500 hover:bg-green-700 text-gray-900 font-bold py-4 px-4 rounded">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-6 py-4 text-center">
                            <a href="{{ route('food.edit',$item->id) }}" class="inline-block bg=blue-500 hover:bg-blue-700 text-dark font-bold py-2 px-4 mx-2 rounded">
                                Edit</a>
